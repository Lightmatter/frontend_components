...
ROOT_URLCONF = "frontend_components.config.urls"
# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "frontend_components.config.wsgi.application"
...
LOCAL_APPS = [
    "frontend_components.home",
    "frontend_components.user",
    "frontend_components.util",
...
MIDDLEWARE = [
    ...
    "frontend_components.util.middleware.HTMXMessageMiddleware",
    "frontend_components.util.middleware.TimezoneMiddleware",
]
    ...
    },
    {
        ...
        "OPTIONS": {
            ...
            "builtins": [
                ...
                "frontend_components.util.templatetags.filters",
            ],
...
def prefixed_cookie(name):
    return f"frontend_components_{name}"
...
ADMINS = [("""Alex Krupp""", "alex@lightmatter.com")]
...
ACCOUNT_ADAPTER = "frontend_components.user.adapter.HTMXAccountAdapter"
ACCOUNT_TEMPLATE_EXTENSION = "jinja"


# https://django-allauth.readthedocs.io/en/latest/forms.html#account-forms
ACCOUNT_FORMS = {
    "login": "frontend_components.user.forms.LoginForm",
    "signup": "frontend_components.user.forms.SignupForm",
}
